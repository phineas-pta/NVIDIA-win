...
tested version: CmdStan v2.39.0: https://github.com/stan-dev/cmdstan/releases/download/v2.39.0/cmdstan-2.39.0.tar.gz
...
OPENCL_DEVICE_ID=0
LDFLAGS_OPENCL=-L"C:/Program Files/NVIDIA GPU Computing Toolkit/CUDA/v13.3/lib/x64" -lOpenCL
```
...
additional step: `export PATH=$PATH:███/cmdstan-2.39.0/stan/lib/stan_math/lib/tbb`
